    ...
    <div className="min-h-screen bg-background">
      <header className="app-header">
        <div className="page-container flex items-center gap-3 py-4">
          ...
          <div>
            <h1 className="text-lg font-semibold text-ink">Emergency SOS</h1>
            <p className="text-sm text-muted">High-priority alerting with freshest available location.</p>
          </div>
        </div>
      </header>
      ...
      <main className="page-container grid gap-6 py-8 lg:grid-cols-[0.92fr_1.08fr]">
        <div className="surface-panel p-8">
          ...
          <h2 className="display-subsection mt-6">The action stays obvious when every second matters.</h2>
        ...
        <div className="product-card space-y-6 p-8">
          <div>
            <h2 className="text-lg font-semibold text-ink">Type of Emergency</h2>
          ...
          <div>
            <label className="mb-2 block text-sm font-semibold text-ink" htmlFor="desc">
